        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-gray-600 dark:text-gray-300">
              Quick overview of your platform's key metrics
            </p>
          </div>
          <button
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <div className="space-y-3">
            {analytics.roleDistribution && Object.entries(analytics.roleDistribution).map(([role, count]) => (
              <div key={role} className="flex items-center justify-between">
                <div className="flex items-center space-x-2">
                  {role === 'admin' && <Crown className="h-4 w-4 text-red-500" />}
                  {role === 'instructor' && <Shield className="h-4 w-4 text-blue-500" />}
                  {role === 'student' && <Users className="h-4 w-4 text-green-500" />}
        ...
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-6">
          ...
          <div className="text-center">
            ...
            <p className="text-gray-600 dark:text-gray-300">
              Total potential revenue from all courses
            </p>
          </div>
        </div>
      </div>
